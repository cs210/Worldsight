...
namespace GracesGames.SimpleFileBrowser.Scripts.UI {
    ...
    public class VRFileButton : MonoBehaviour, IPointerClickHandler {

        // The file browser using this file button
        private VRFileBrowserController _fileBrowser;
        ...
        public void Setup(VRFileBrowserController fileBrowser, string path, bool interactable) {
